...
with tab1:
    ...
    with st.expander("📈 HIV Testing Trends by Month", expanded=True):
        ...
        fig1.add_hline(
            y=1673, line_dash="dash", line_color="red", line_width=3,
            annotation_text="Target = 1,673", annotation_position="top left"
        )
        fig1.update_layout(
            yaxis_title="Number Tested", xaxis_title="Month",
    ...
    with st.expander("ICT - HTS Percentage"):
        ...
        fig3.add_hline(
            y=30, line_dash="dash", line_color="red", line_width=3,
            annotation_text="Target = 30%", annotation_position="top left"
        )
        fig3.update_layout(
            yaxis_title="ICT Percentage (%)", xaxis_title="Month",
            yaxis_range=[0, 100]
        )
    ...
    with st.expander("ICT Testing Types"):
        ...
        fig4.add_hline(
            y=502, line_dash="dash", line_color="red", line_width=3,
            annotation_text="Target = 502", annotation_position="top left"
        )
        fig4.update_layout(yaxis_title="Number Tested", xaxis_title="Month")
...
with tab2:
    ...
    with st.expander("Viral Coverage and Suppression by Month"):
        ...
        fig8.update_layout(
            ...
            legend_title="Indicator", hovermode="x unified"
        )
